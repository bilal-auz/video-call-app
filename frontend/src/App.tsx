...
function App() {
  ...
  return (
    <div className="App">
      <main className="flex flex-col justify-center items-center bg-[#161b21]">
        <h1 className="text-4xl font-bold mb-1 text-[#15E8D8]">
          Video Call App
          <a href="https://github.com/bilal-auz/video-call-app" target="_blank">
            <svg
        ...
        <div className="flex flex-col justify-start items-center mt-5">
          <div className="flex flex-row justify-center items-center bg-[#1f272f] rounded-lg p-5">
          ...
          <div className="flex flex-row justify-around items-center w-full mt-5 bg-[#1f272f] rounded-lg p-5">
          ...
          <div className="footer flex flex-row items-center justify-around text-base-content rounded pt-5 pb-5">
            <aside>
              <p className="inline text-[#485c70]  ml-2 text-base">
                Copyright © 2023 By <span className="text-[#15E8D8]">@</span>
                <a
